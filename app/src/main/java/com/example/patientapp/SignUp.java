    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String getConfpass=ed3.getText().toString();
                String getAge=ed4.getText().toString();
                String getHouse=ed5.getText().toString();
                String getPin=ed6.getText().toString();
                String getMob=ed7.getText().toString();

                Toast.makeText(getApplicationContext(),getName+getPass+getConfpass+getAge+getHouse+getPin+getMob,Toast.LENGTH_LONG).show();
